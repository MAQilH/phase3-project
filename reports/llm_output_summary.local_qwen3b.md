...
- JSON validity rate (first attempt): 0.00%
...
Query `q001` fell back to the deterministic fallback answer after 2 retries; last validation error: invalid JSON: Expecting ',' delimiter: line 9 column 4 (char 302)
